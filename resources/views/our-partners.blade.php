...
<section>
    <div class="our-partners h-[100vh] flex justify-center items-center flex-col">
        <div class="text-center text-white pb-2 mt-[2rem]">
            <h2 class="text-6xl font-bold">Our Partners</h2>
        </div>
...
<section class="bg-[#0D1118]">
                ...
                <div class="flex flex-col gap-6">
                    ...
                    <div class="flex flex-row gap-3 ">
                        <a href="/cart" class="bg-[#FFC66A] rounded-lg px-4 py-[0.35rem] font-semibold text-black">Book
                            Now</a>
                        <button class="text-[#FFC66A]">View Gallery</button>
                    </div>
                </div>
    ...
    <div class="flex flex-col gap-[5rem]">
        ...
        <div class="flex flex-col gap-5">
            ...
            <p class="text-white text-sm">Hot Air Balloon in Dubai is a must-do experience.<br> In conjunction with Balloon Adventures Dubai, the longest<br> operating balloon company in Dubai,<br>
                take in the stunning views while floating over the Dubai <br>desert.</p>
                <a href="/explore-partner" class="bg-[#FFC66A] rounded-lg px-4 py-[0.35rem] font-semibold text-black w-max">Explore</a>
            </div>
        <div class="flex flex-row gap-4 items-end">
            <div class="flex-1">
                <img src="{{asset('images/partners-sm.png')}}"
                    class="h-min object-cover">
            </div>
            <div class="flex-1">
                <img src="{{asset('images/partners-lg.png')}}"
                    class="h-min object-cover">
            </div>
